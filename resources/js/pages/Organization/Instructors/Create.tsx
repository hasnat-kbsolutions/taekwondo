...
export default function Create({ clubs, students, selected_club_id }: Props) {
    ...
    React.useEffect(() => {
        if (data.club_id) {
            router.visit(route("organization.instructors.create"), {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        post(route("organization.instructors.store"), {
            forceFormData: true,
        });
    };
