...
export default function Show({
    ...
    return (
        <AuthenticatedLayout header="Organization Profile">
                                        ...
                                        {organization.average_rating && (
                                            <div className="flex items-center gap-2 ml-auto">
                                                ...
                                                <span className="text-sm text-muted-foreground">
                                                    {organization.average_rating.toFixed(
                                                        1
                                                    )}{" "}
                                                    (
                                                    {organization.total_ratings}{" "}
                                                    ratings)
                                                </span>
                                            </div>
                                        )}
                            ...
                            <CardContent>
                                <div className="space-y-3">
                                    ...
                                    <Button
                                        ...
                                        onClick={() =>
                                            (window.location.href = route(
                                                "organization.instructors.index"
                                            ))
                                        }
                                    >
                                    ...
                                    <Button
                                        ...
                                        onClick={() =>
                                            (window.location.href = route(
                                                "organization.certifications.index"
                                            ))
                                        }
                                    >
                                    ...
                                    <Button
                                        ...
                                        onClick={() =>
                                            (window.location.href = route(
                                                "organization.attendances.index"
                                            ))
                                        }
                                    >
