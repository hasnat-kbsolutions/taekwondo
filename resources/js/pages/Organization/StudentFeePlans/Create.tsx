...
export default function Create() {
    ...
    // Filter plans: show organization plans + student's club plans
    ...
    const submit = (e: React.FormEvent) => {
        e.preventDefault();
        router.post(route("organization.student-fee-plans.store"), {
    ...
    return (
        <AuthenticatedLayout header="Assign Student Fee Plan">
            <Head title="Assign Student Fee Plan" />
            <div className="p-6">
                <Card>
                    <CardHeader>
                        <CardTitle>Assign Student Fee Plan</CardTitle>
                    </CardHeader>
                    <CardContent>
                        <form
                            onSubmit={submit}
