...
export default function Index() {
    ...
    const filteredClubs =
        orgFilter && orgFilter !== "all"
            ? clubs.filter((c: any) => c.organization_id === Number(orgFilter))
            : clubs;

    const handleFilter = () => {
        router.get(route("admin.plans.index"), {
            organization_id:
                orgFilter && orgFilter !== "all" ? orgFilter : null,
                        ...
                        <div className="grid grid-cols-3 gap-4 items-end">
                            <div>
                                ...
                                <Select
                                    ...
                                    onValueChange={(value) => {
                                        setOrgFilter(value);
                                        setClubFilter("all"); // Reset club when org changes
                                    }}
                                >
                                    <SelectTrigger>
                            ...
                            <div>
                                ...
                                <Select
                                    ...
                                    disabled={!orgFilter || orgFilter === "all"}
                                >
                                    <SelectTrigger>
