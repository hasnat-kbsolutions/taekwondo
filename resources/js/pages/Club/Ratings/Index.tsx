...
const ClubRatingsIndex: React.FC<Props> = ({ ratings, stats }) => {
        ...
        <AuthenticatedLayout header="Ratings Overview">
            ...
            <div className="container mx-auto py-10">
                ...
                <Card>
                    <CardHeader>
                        <CardTitle>
                            Student & Instructor Ratings ({ratings.length})
                        </CardTitle>
                    </CardHeader>
                    <CardContent>
                        {ratings.length > 0 ? (
...
export default ClubRatingsIndex;
