...
class StudentController extends Controller
{
    public function index(Request $request)
    {
        ...
        return Inertia::render('Branch/Students/Index', [
            'students' => $students,
    ...
    public function create()
    {
        ...
        return Inertia::render('Branch/Students/Create', [
            'branches' => $branches,
    ...
    public function store(Request $request)
    {
        ...
        if (Auth::user()->role === 'branch') {
            $data['branch_id'] = Auth::user()->userable_id;
    ...
    public function edit(Student $student)
    {
        ...
        return Inertia::render('Branch/Students/Edit', [
            'student' => $student,
            // 'branches' => $branches,
            // 'organizations' => $organizations,
            'clubs' => $clubs,
    ...
    public function update(Request $request, Student $student)
    {
        ...
        // Inject organization_id if the logged-in user is an organization
        if (Auth::user()->role === 'branch') {
            $validated['branch_id'] = Auth::user()->userable_id;
    ...
    public function destroy(Student $student)
    {
        ...
        return redirect()->route('branch.students.index')->with('success', 'Student deleted');
    }
}
