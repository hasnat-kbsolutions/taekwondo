...
class StudentInsightsController extends Controller
{
    public function show(Request $request, Student $student)
    {
        ...
        // Ensure the student belongs to this organization
        ...
        return Inertia::render('Organization/StudentInsights/Show', [
            'student' => $student,
    ...
    private function getPerformanceAnalytics($student, $request)
    {
        ...
        // Compare with organization average
        $organization = Auth::user()->userable;
        $orgAverage = Attendance::whereHas('student', function ($query) use ($organization) {
        ...
        $orgAverageRate = $orgAverage && $orgAverage->total > 0
            ? (float) round(($orgAverage->present / $orgAverage->total) * 100, 2)
            : 0.0;
        ...
        return [
            ...
            'club_comparison' => [
                ...
                'club_average' => $orgAverageRate,
                'performance' => $this->getAttendanceInsights($student, $request)['summary']['attendance_rate'] >= $orgAverageRate ? 'above' : 'below',
            ],
        ];
    }
