...
{
    /**
     * Display the organization login view.
     */
    public function create(): Response
    {
        return Inertia::render('auth/organization-login');
    }
    ...
    public function store(LoginRequest $request)
    {
        ...
        $request->authenticateWithRole('organization');

        $request->session()->regenerate();

        return redirect()->intended(RouteServiceProvider::ORGANIZATION_HOME);
    }
