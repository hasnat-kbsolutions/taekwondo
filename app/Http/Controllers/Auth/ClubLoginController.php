...
{
    /**
     * Display the club login view.
     */
    public function create(): Response
    {
        return Inertia::render('auth/club-login');
    }
    ...
    public function store(LoginRequest $request)
    {
        ...
        $request->authenticateWithRole('club');

        $request->session()->regenerate();

        return redirect()->intended(RouteServiceProvider::CLUB_HOME);
    }
